...
Follow download and install instructions at `DS9 <https://ds9.si.edu/doc/install.html>`_. Open both TOPCAT and DS9 (instructions in section 2) or TOPCAT and Aladin (instructions in section 3) software programs.

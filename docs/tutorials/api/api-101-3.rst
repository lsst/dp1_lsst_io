...
**NOTE: It is recommended to construct a TAP query using spatial constraints, but his query has been limited to the top 1000 entries.  This should limit the time it takes to run the query.**

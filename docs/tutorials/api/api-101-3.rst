...
Obtain a token that uses **read: image**.
...
Open both TOPCAT and DS9 (instructions in section 2) or TOPCAT and Aladin (instructions in section 3) software programs.
Screenshots for this tutorial were generated using TOPCAT Version 4.10-7, SAOImageDS9 Verions 8.6, and Aladin (v 12.060).
Access to image‑retrieval features may depend on running an up‑to‑date installation of the software.

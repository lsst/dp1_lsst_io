...
Click on the "Plane plotting window" (icon next to the "Histogram" icon in Figure 4), add "g_psfMag-r_psfMag" in the "X:" selection box and "r_psfMag-i_psfMag" in the "Y:" box.

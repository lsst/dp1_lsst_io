...
###################################################################
101.3. How to use TOPCAT and SIA to get DP1 images on ds9 or Aladin
###################################################################
...
Follow download and install instructions at `DS9 <https://ds9.si.edu/doc/install.html>`_ and `Aladin <https://aladin.cds.unistra.fr/AladinDesktop/#Download>`_. Open both TOPCAT and DS9 (instructions in section 2) or TOPCAT and Aladin (instructions in section 3) software programs.


**2. View images with SAOImageDS9: Verify TOPCAT and DS9 are open and communicating**

On the TOPCAT menu bar, click Interop, SAMP Status (Figure 1) to verify TOPCAT and DS9 are properly configured.
...
A pop up window will open (Figure 2) showing SAMP Control active clients: Hub, topcat, and ds9 (Figure 3).
...
Add in the credentials created during API Tutorial 101, “How to get started with TOPCAT” (Figure 5). Press Authenticate.
...
Click the Dipslay actions invoked when rows are selected button (resembles a ladder with a lightning bolt) (Figure 7), to open the TOPCAT: Activation Actions window. 
...
Click the “View URL option” (Figure 8).
...
**3. View images with Aladin**

Follow the TOPCAT instructions listed in **2. View images with SAOImageDS9: Verify TOPCAT and DS9 are open and communicating** and beyond but open Aladin instead of SAOImageDS9.
After completing step 2.8 (listed above) the following image will appear in Aladin (Figure 13). Use Aladin controls to scale or zoom within the image.

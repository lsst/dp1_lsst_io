...
Add ``g_psfMag-r_psfMag`` in the "X:" selection box and ``r_psfMag-i_psfMag`` in the "Y:" box, then hit "Enter".
...
TOPCAT does not currently provide keyboard shortcuts for zooming.
Figure 8 shows a zoomed in view of the highest concentration of stars. Click the "?" icon at th elower left for further instructions.

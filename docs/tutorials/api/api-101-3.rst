...
Create a skymap of the Data Preview 1 Dataset using TOPCAT and an "aitoff" projection.

**2.1 Use TAP Query window**

After starting TOPCAT and accessing the Rubin DP1 data through the VO protocol, where you add your credentials, click on "dp1.CoaddPatches" table in the Table Access

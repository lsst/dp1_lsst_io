...
``INEXACT_PSF`` (bit: ``13``; 2ⁿ: ``8192``)
    Used on :ref:`deep coadds <images-deep-coadd>` only; see the :ref:`deep and template coadds mask planes <images-deep-coadd-mask-planes>` page.

``INJECTED`` (bit: ``14``; 2ⁿ: ``16384``)
...
``INJECTED_TEMPLATE`` (bit: ``15``; 2ⁿ: ``32768``)
...
``NOT_DEBLENDED`` (bit: ``17``; 2ⁿ: ``131072``)
...
``SENSOR_EDGE`` (bit: ``20``; 2ⁿ: ``1048576``)
    Used on :ref:`deep coadds <images-deep-coadd>` only; see the :ref:`deep and template coadds mask planes <images-deep-coadd-mask-planes>` page.

``STREAK`` (bit: ``10``; 2ⁿ: ``1024``)
